        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <form action="/data-kelahiran/edit/{{$lahir->kelahiran_id}}/save" id="form1" method="POST"
                        enctype="multipart/form-data">
                        @csrf {{ method_field('patch')}}
                        <div class="card-body">
                            <div class="form-group">
                                <label>Nama Bayi</label>
                                <input type="text" name="kelahiran_nama" value="{{$lahir->kelahiran_nama}}" required
                                    placeholder="Masukan Nama" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Tempat Lahir Bayi</label>
                                <input type="text" name="kelahiran_tempat" value="{{$lahir->kelahiran_tempat}}" required
                                    placeholder="Masukan Tempat Lahir" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Tanggal Lahir Bayi</label>
                                <input type="date" name="kelahiran_tgl" value="{{$lahir->kelahiran_tgl}}" required
                                    placeholder="Masukan Tanggal Lahir" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Berat Bayi</label>
                                <input type="number" name="kelahiran_berat" value="{{$lahir->kelahiran_berat}}" required
                                    placeholder="Masukan Berat" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Nama Ayah</label>
                                <input type="text" name="kelahiran_nama_ayah" value="{{$lahir->kelahiran_nama_ayah}}"
                                    required placeholder="Masukan Nama Ayah" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Nama Ibu</label>
                                <input type="text" name="kelahiran_nama_ibu" value="{{$lahir->kelahiran_nama_ibu}}"
                                    required placeholder="Masukan Nama Ibu" class="form-control">
                            </div>
